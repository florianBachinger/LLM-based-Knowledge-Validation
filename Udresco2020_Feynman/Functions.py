...
{'EquationName': 'Feynman23', 'DescriptiveName': 'Feynman23, Lecture I.18.16', 'Formula_Str': 'm*r*v*sin(theta)', 'Formula': 'm*r*v*np.sin(theta)', 'Formula_Lambda': 'lambda args : (lambda m,r,v,theta: m*r*v*np.sin(theta) )(*args)', 'Formula_Lambda_Stump': 'lambda args : (lambda m,r,v,theta: {0} )(*args)', 'Variables': [{'name': 'm', 'low': 1.0, 'high': 5.0}, {'name': 'r', 'low': 1.0, 'high': 5.0}, {'name': 'v', 'low': 1.0, 'high': 5.0}, {'name': 'theta', 'low': 1.0, 'high': 5.0}]},
